    ...
    <div class="content-list">
        <table class="list-route">
            ...
            <tbody>
                ...
                <tr class="table-row" data-category="{{$condition->conditioncategory_id}}">
                    <td class="td-widthfixed">
                        {{ config('condition_category.' .$condition->conditioncategory_id) }}
                    </td>
                    <td class="td-widthfixed">{{ $condition->flag }}</td>
                    <td class="td-alignleft">{{ $condition->content }}</td>
                    <td class="td-widthfixed"><a href="{{ route("conditionEdit", ["id" => $condition->id ]) }}"><span class="style-detail">詳細</span></td>
                </tr>
                @endforeach
